# Foodstore - Интернет-магазин еды

Современное React приложение для интернет-магазина еды с кастомной конфигурацией Webpack, TypeScript и полным набором инструментов для разработки. Проект использует архитектуру Feature-Sliced Design и демонстрирует реализацию адаптивной шапки с корзиной, анимациями и современными практиками разработки.
...
Проект создан в рамках тестового задания для демонстрации навыков современной разработки React приложений.